...
class RustLib extends BaseEntrypoint<RustLibApi, RustLibApiImpl, RustLibWire> {
  ...
  @override
  int get rustContentHash => 1841053012;
...
abstract class RustLibApi extends BaseApi {
  ...
  Future<String> crateApiAgentLoopApiContinueClaudeAgentLoop({
    required String stateJson,
    required String toolResultsJson,
  });

  Future<String> crateApiAgentLoopApiContinueOpenaiAgentLoop({
    required String stateJson,
    required String toolResultsJson,
  });
  ...
  Future<String> crateApiAgentLoopApiStartClaudeAgentLoop({
    required String baseUrl,
  ...
  Future<String> crateApiAgentLoopApiStartOpenaiAgentLoop({
    required String baseUrl,
    required String apiKey,
    required String modelId,
    required String messagesJson,
...
class RustLibApiImpl extends RustLibApiImplPlatform implements RustLibApi {
    ...
    return handler.executeNormal(
      NormalTask(
        callFfi: (port_) {
          ...
          sse_encode_String(toolResultsJson, serializer);
          pdeCallFfi(
            generalizedFrbRustBinding,
            serializer,
            funcId: 35,
        ...
        constMeta: kCrateApiAgentLoopApiContinueClaudeAgentLoopConstMeta,
        argValues: [stateJson, toolResultsJson],
        apiImpl: this,
      ),
    );
  }

  TaskConstMeta get kCrateApiAgentLoopApiContinueClaudeAgentLoopConstMeta =>
      const TaskConstMeta(
        debugName: "continue_claude_agent_loop",
        argNames: ["stateJson", "toolResultsJson"],
      );
  ...
  Future<String> crateApiAgentLoopApiContinueOpenaiAgentLoop({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAgentLoopApiContinueOpenaiAgentLoopConstMeta,
        argValues: [stateJson, toolResultsJson],
        apiImpl: this,
      ),
    );
  ...
  TaskConstMeta get kCrateApiAgentLoopApiContinueOpenaiAgentLoopConstMeta =>
      const TaskConstMeta(
        debugName: "continue_openai_agent_loop",
        argNames: ["stateJson", "toolResultsJson"],
      );
  ...
  Future<String> crateApiAgentLoopApiStartClaudeAgentLoop({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAgentLoopApiStartClaudeAgentLoopConstMeta,
        argValues: [
          baseUrl,
          apiKey,
          modelId,
  ...
  TaskConstMeta get kCrateApiAgentLoopApiStartClaudeAgentLoopConstMeta =>
      const TaskConstMeta(
        debugName: "start_claude_agent_loop",
        argNames: [
          "baseUrl",
          "apiKey",
          "modelId",
  ...
  Future<String> crateApiAgentLoopApiStartOpenaiAgentLoop({
    ...
    return handler.executeNormal(
      NormalTask(
        ...
        constMeta: kCrateApiAgentLoopApiStartOpenaiAgentLoopConstMeta,
        argValues: [
          baseUrl,
          apiKey,
          modelId,
  ...
  TaskConstMeta get kCrateApiAgentLoopApiStartOpenaiAgentLoopConstMeta =>
      const TaskConstMeta(
        debugName: "start_openai_agent_loop",
        argNames: [
          "baseUrl",
          "apiKey",
          "modelId",
